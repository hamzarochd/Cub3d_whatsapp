...
int			handle_config(t_cube *cube, char **splitted, char *line,
				int counter);
void		draw_filled_circle(t_mlx *mlx, int x_center, int y_center,
				int radius);
t_point		get_h_wall(t_mlx *mlx, t_point player_pt,
				double ray_angle, double *ray_lenght);
t_point		get_v_wall(t_mlx *mlx, t_point player_pt,
				double ray_angle, double *ray_lenght);
void		fire_hook(mouse_key_t button, action_t action,
