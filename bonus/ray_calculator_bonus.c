...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ray_calculator_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hrochd <hrochd@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/26 19:18:19 by hrochd            #+#    #+#             */
/*   Updated: 2025/04/26 19:22:00 by hrochd           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_hray(t_mlx *mlx, t_ray *ray, t_point wall_pt)
{
	...
	if ((ray->wall_orientation == 'N'
			&& is_in_door(map, wall_pt.x, wall_pt.y - 1, mlx))
...
void	get_vray(t_mlx *mlx, t_ray *ray, t_point wall_pt)
{
	...
	if (ray->wall_orientation == 'W')
		ray->tile_hit_point = TILE_SIZE - ray->tile_hit_point;
	if ((ray->wall_orientation == 'W'
			&& is_in_door(map, wall_pt.x - 1, wall_pt.y, mlx))
