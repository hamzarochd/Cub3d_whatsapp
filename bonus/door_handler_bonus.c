...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/26 18:16:23 by hrochd            #+#    #+#             */
/*   Updated: 2025/04/26 18:19:50 by hrochd           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	open_door(struct mlx_key_data keydata, void *param)
{
	...
	{
		if (mlx->player.rot_angle >= PI / 4
			&& mlx->player.rot_angle < 3 * (PI / 4))
			handle_north_door(map, player_x, player_y);
		else if (mlx->player.rot_angle >= 3 * (PI / 4)
			&& mlx->player.rot_angle < 5 * (PI / 4))
			handle_west_door(map, player_x, player_y);
		else if (mlx->player.rot_angle >= 5 * (PI / 4)
			&& mlx->player.rot_angle < 7 * (PI / 4))
