...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pixel_putters_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hrochd <hrochd@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/26 19:03:54 by hrochd            #+#    #+#             */
/*   Updated: 2025/04/26 19:18:12 by hrochd           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_wall(t_mlx *mlx, int i, int *j, t_wall wall)
{
	...
	while (k < wall.wall_end)
	{
		...
		in = (wall.tex.texel_y + wall.tex.texel_x);
		wall.tex.texel_color = ((uint32_t *)(wall.wall_texture->pixels))[in];
